...
module.exports = yeoman.generators.Base.extend({
    ...
    writing:{
        ...
        service:function(){
               ...
               var destination = this.destinationPath('src/app/home/components/'+this.metadata.title+'.ts');                
               this.fs.copyTpl(template,destination,this.metadata);         
        },
        spec:function(){
               var template = this.templatePath('component.spec');
               var destination = this.destinationPath('src/specs/home/components/'+this.metadata.title+'.spec.ts'); 
               this.fs.copyTpl(template,destination,this.metadata); 
        }
